  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ...
        if (controller.isLoading.value) {
          return Container(
            decoration: BoxDecoration(
              color: Colors.grey[300], // Varsayılan loading rengi
            ),
            child: Scaffold(
        ...
        if (controller.selectedIndex.value >= controller.cards.length) {
          return Container(
            decoration: BoxDecoration(
              color: Colors.grey[300],
            ),
        ...
        final currentCard = controller.cards[controller.selectedIndex.value];
        final cardColor = currentCard['color'];
        print('[CARD SCREEN] ===== CARD COLOR DEBUG =====');
        print(
            '[CARD SCREEN] Selected Index: ${controller.selectedIndex.value}');
